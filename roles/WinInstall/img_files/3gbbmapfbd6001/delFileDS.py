...
def main():
    ...
    try:
        ...
        try:
            ...
            si = connect.Connect('3gbv1apvmw1001.national.core.bbc.co.uk', 443, 'ere-mid-tf@national', 'W@shed5ocks!')
        except IOError, e:
            pass
	...
	get_datacenter_datastore(si, 'TS S1 DS BACKUP')
	delfile(si, '[TS S1 DS BACKUP]ISOs/ansible/3gbbmapfbd6001.img')
